...
class TushareData:
    ...
    # weekly index
    def weekly_index(self, index_name, ts_code, start_date='', end_date=''):
        try:
            df = self.pro.index_weekly(**{
                "ts_code": ts_code,
                "trade_date": "",
    ...
    # test
    def test(self):
        # index_test = self.daily_index(index_name='沪深300', ts_code='000300.sh',
        ...
        daily_bar = self.pro_bar(ts_code='000001.sz', start_date='20201231', end_date='20211231')
        print(daily_bar.head())
...
if __name__ == '__main__':
    ...
    td = TushareData()
    df = td.pro_bar(ts_code='000001.SZ', start_date='20201231', end_date='20211231')
    print(df.head(5))